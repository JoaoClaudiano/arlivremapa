...
🧑‍💻 **Usuário**
   │
   ├── Clica em mapa / card → 🌐 **Home.js** (Página Inicial)
   │                           │
   │                           └── MapView.js (Mapa interativo)
   │                                 │
   │                                 ▼
   │                          Firestore → Collection: `spaces`
   │                                 │
   │                                 ▼
   │                          SpaceDetail.js (Detalhes do espaço)
   │
   └── Clica em blog → 📖 **Blog.js** (Lista de posts)
                                │
                                └── BlogList.js
                                      │
                                      ▼
...
🟢 **Componentes fixos**
- Header.js → Barra superior, navegação
- Footer.js → Rodapé, créditos e informações do site
